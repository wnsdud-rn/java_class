...
public class CaesarCipher2 {
	...
	public static String decryption(String crypto_text) {
	...
	public static void main(String[] args) {
		...
		String crypto = new CaesarCipher2(3).encryption("hello, World!");
		System.out.println(crypto);
		String text = new CaesarCipher2(3).decryption(crypto);
